...
echo<<<END
	...
	<form method="post" id="upload_notice" role="form" enctype="multipart/form-data">
		...
		<div class="notice_upload_inner">
			...
			<label for="Noticeboard_no" class="control-label" id="noticeboard_no_label">NoticeBoard Number:</label>
			<input type="text" name="Noticeboard_no" id="noticeboard_no" value="1" >			
		...
		<div class="btn-group notice_type">
			...
			<ul class="dropdown-menu">
				<blockquote><h5>
					...
					<input type="radio" name="notice_type_no" value="2"> 2-Private</h5>
				</blockquote>
			</ul>
		</div>
		<hr>
...
echo<<<END
<div>
<div class="col-md-8 column" id="contact_us_form">
